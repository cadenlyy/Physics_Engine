...
//functions
template<typename T>
matrix2<T>::matrix2() { //default constructor
	m_nRows = 1;
	m_nCols = 1;
	m_nElements = 1;
...
template<typename T>
matrix2<T>::matrix2(int nRow, int nCol) {
	m_nRows = nRow;
	m_nCols = nCol;
...
template<typename T>
matrix2<T>::matrix2(int nRow, int nCol, const T* data) {
	m_nRows = nRow;
	m_nCols = nCol;
	m_nElements = nRow * nCol;
	matrixData = new T[m_nElements];
...
//config functions
template<typename T>
void matrix2<T>::resize(int nRow, int nCol) {
	delete[] matrixData;
	m_nRows = nRow;
	m_nCols = nCol;
	m_nElements = nRow * nCol;
...
//element functions
template<typename T>
int matrix2<T>::get(int row, int col) {
	int linearIndex = index(row, col);
	return matrix2<T>::matrixData[linearIndex];
}

template<typename T>
void matrix2<T>::set(int row, int col, T value) {
	int linearIndex = index(row, col);
	matrixData[linearIndex] = value;
}

template<typename T>
int matrix2<T>::getRows() {
	return m_nRows;
}

template<typename T>
int matrix2<T>::getCols() {
	return m_nCols;
}

template<typename T>
int matrix2<T>::index(int row, int col) {
